...
:POST_ARGS_LOOP
%MSBUILD% %~dp0\AOSCOSLauncher.sln /t:%_MSBUILD_TARGET% /m /nr:true /p:Configuration=%_MSBUILD_CONFIG%;Platform=x64

if (%ERRORLEVEL%) == (0) (
    echo.
    echo Created appx in %~dp0x64\%_MSBUILD_CONFIG%\AOSCOSLauncher-Appx\
    echo.
)
